...
public class Project19 extends JFrame implements ActionListener
{
	...
	public Project19()
	{
		...
		l3.setBounds(500,5,400,60);
		p1.add(l3);
		
		b2 = new JButton("Scarf price");
		...
		b3 = new JButton("Ear rings price");
		...
		l4 = new JLabel("Ear rings Amount");
	...
	public void actionPerformed(ActionEvent ae)
		{
          ...
          final String scarf = t1.getText();
			 final String earrings=t2.getText();
             final String glasses = t3.getText();
             final String address = t4.getText();			 
           if(ae.getSource()==b1)
		   {if (scarf.trim().equals(t1.getText()) && earrings.trim().equals(t2.getText()) && glasses.trim().equals(t3.getText())&& address.trim().equals(t4.getText()) )
		     {
