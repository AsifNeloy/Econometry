	...
	public void actionPerformed(ActionEvent ae)
		{
          ...
          final String phoneNumber = t1.getText();
			 final String accNumber=t2.getText();
             final String password = passPF.getText(); 
           if(ae.getSource()==b1)
		   {if (phoneNumber.trim().equals(t1.getText()) && accNumber.trim().equals(t2.getText()) && password.trim().equals(passPF.getText()) )
		     {
