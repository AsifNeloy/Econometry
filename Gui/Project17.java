...
public class Project17 extends JFrame implements ActionListener
{
	...
	public void actionPerformed(ActionEvent ae)
		{
          ...
          final String monas = t1.getText();
			 final String fenat=t2.getText();
             final String rabe = t3.getText();
             final String address = t4.getText();			 
           if(ae.getSource()==b1)
		   {if (monas.trim().equals(t1.getText()) && fenat.trim().equals(t2.getText()) && rabe.trim().equals(t3.getText())&& address.trim().equals(t4.getText()) )
		     {
